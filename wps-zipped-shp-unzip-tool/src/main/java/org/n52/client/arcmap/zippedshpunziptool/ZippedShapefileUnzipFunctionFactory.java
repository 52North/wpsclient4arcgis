...
public class ZippedShapefileUnzipFunctionFactory implements IGPFunctionFactory {
     ...
     * 
     */
    private static final long serialVersionUID = -4049280720015080460L;

    private String functionFactoryAlias = "zippedshpfileunzipfunctionfactory";

    private String factoryName = "ZippedShapefileUnzipFunctionFactory";
    ...
    public IGPFunction getFunction(String name) throws IOException, AutomationException {
        if (name.equalsIgnoreCase(toolName)) {
            return new ZippedShapefileUnzipTool();
        }
